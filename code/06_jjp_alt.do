**# Bookmark #1
/*==============================================================================
Project    : School Spending - Build analysis_panel_bal_alt Dataset (ALTERNATIVE BALANCE)
File       : 06_jjp_alt.do
...
WHAT THIS FILE DOES:
  ...
  - Step 6: Save analysis_panel_bal_alt.dta
...
OUTPUTS:
  - analysis_panel_unrestricted_alt.dta      (Full county panel before balance restriction)
  - analysis_panel_bal_alt.dta       (Balanced panel with state filter applied)
...
*** ---------------------------------------------------------------------------
save analysis_panel_unrestricted_alt, replace
...
drop year4 good_county good_county_* never_treated n_obs balanced  ///
     county_name  ever_treated exp_ma  exp_ma_strict // dup_tag
...
save analysis_panel_bal_alt, replace
