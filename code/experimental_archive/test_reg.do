...
* 1966
collapse (sum) school_age_pop, by(pre_q1966)
list
use jjp_interp, clear

* 1969
collapse (sum) school_age_pop, by(pre_q1969)
list
use jjp_interp, clear

* 1970
collapse (sum) school_age_pop, by(pre_q1970)
list
use jjp_interp, clear

* 1971
collapse (sum) school_age_pop, by(pre_q1971)
list
